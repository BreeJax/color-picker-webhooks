...
class App extends Component {
  ...
  random = () => {
    ...
    this.getHSLA();
    // console.log(`Hue: ${this.state.Hue}, Saturation: ${this.state.Saturation}, Light: ${this.state.Light}, Alpha: ${this.state.Alpha}`);
  };
  getHSLA = () => {
      ...
      <div className="App">
        ...
        <form>
          ...
          <Slider
            ...
            step="1"
            handleChange={(value) => this.updateHue(value)}
          />
          <p>SATURATION</p>
          <Slider
            title="Saturation"
            ...
            step="1"
            handleChange={(value) => this.updateSaturation(value)}
          />
          <p>LIGHT</p>
          <Slider
            title="Light"
            ...
            step="1"
            handleChange={(value) => this.updateLight(value)}
          />
          <p>ALPHA</p>
          <Slider
            title="Alpha"
            ...
            step="0.01"
            special="alphaImage"
            handleChange={(value) => this.updateAlpha(value)}
          />
        </form>
      </div>
    );
